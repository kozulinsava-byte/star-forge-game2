...
function showContractModal() {
  ...
  // Собираем доступные для синтеза слитки
  ...
  const html = `
    <style>
      ...
      .contract-result-icon {
        font-size: 80px;
        animation: successBurst 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards;
      }
