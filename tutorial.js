...
const HELP_CONTENT = {
  expeditions: {
    ...
    text: `
      ...
      <p>📌 <strong>Как отправить шахтёров:</strong> нажмите на карточку локации → «Подробнее» → «Отправиться». Экспедиция займёт указанное время.</p>
      ...
      <p>📌 <strong>Локации Трясины:</strong> Болото (ур. 1) → Гнилой лес (ур. 3) → Ржавое дно (ур. 6). Каждая следующая локация даёт более ценные ресурсы.</p>
      <p>💡 <strong>Совет:</strong> начинайте с Болота. Как только откроете Гнилой лес — переключайтесь на него ради вторичных слитков. Ржавое дно открывается на 6 уровне Слитка.</p>
    `
  },
  ingot: {
    title: '⚒️ Слиток',
    text: `
      ...
      <p>📌 <strong>Энергия:</strong> восстанавливается автоматически (3 ед/сек). Коричневая полоска под Слитком показывает запас.</p>
      ...
      <p>📌 <strong>Уровни Слитка:</strong> 6 уровней эпохи Трясины — от «Грязевого сгустка» до «Мусорного сплава». Каждый новый уровень увеличивает силу тапа.</p>
  ...
  inventory: {
    ...
    text: `
      ...
      <p>📌 <strong>Редкость:</strong> слитки бывают разных редкостей — от Хлама до Легендарных. Чем выше редкость — тем ценнее!</p>
  ...
  collection: {
    ...
    text: `
      ...
      <p>📌 <strong>Коллекционные артефакты:</strong> нельзя продать или использовать в крафте — это чистый престиж! Их можно экипировать во вкладке «Слиток» для получения бонусов.</p>
  ...
  events: {
    ...
    text: `
      ...
      <p>　• <strong>🔥 Великая Переплавка</strong> — открывает доступ к Плавильне, где можно создавать крафтовые слитки из метеоритных ресурсов.</p>
  ...
  profile: {
    ...
    text: `
      ...
      <p>📌 <strong>Уровень и статус:</strong> растёт с эволюцией Слитка. От «Болотного странника» до «Легенды Трясины».</p>
    ...
    subSteps: [
      {
        ...
        text: 'Стань легендарным кузнецом Трясины. Добывай ресурсы из болот, гнилых лесов и ржавых глубин. Куй слитки и собирай редчайшие артефакты. Давай освоим основы за пару минут!',
        position: 'center',
        arrowSide: null
      }
    ]
    ...
    subSteps: [
      {
        ...
        text: 'Тапай по нему, чтобы выбивать кузнечную стружку. Каждый тап тратит энергию (коричневая полоска). С шансом 1% включается КУЗНЕЧНЫЙ РАЖ — ×4 стружки на 10 секунд!',
        position: 'top',
        arrowSide: 'bottom'
      },
      {
        ...
        title: '📋 Цель — эволюция',
        text: 'Здесь — твоя цель. Собери нужное количество стружки и слитков Трясины. Когда шкала опыта заполнится — жми «ПЕРЕПЛАВИТЬ СЛИТОК» для повышения уровня! Всего 6 уровней: от Грязевого сгустка до Мусорного сплава.',
        position: 'top',
        arrowSide: 'bottom'
      }
    ]
    ...
    subSteps: [
      {
        ...
        useStaticCoords: false,
        title: '🫧 Болото — твой первый рубеж',
        text: 'Отправляйся в Болото. Там ты найдёшь Влажный песок, Слитки грязи и Тинистые комья — основу для первых эволюций Слитка.',
        position: 'bottom',
        arrowSide: 'top'
      },
      {
        ...
        text: 'Гнилой лес откроется на 3 уровне Слитка, а Ржавое дно — на 6. Там ждут Вторичные и Обычные слитки для дальнейшего развития!',
        position: 'bottom',
        arrowSide: 'top'
      }
    ]
    ...
    subSteps: [
      {
        ...
        text: 'Здесь хранятся все жеоды и слитки. Переключайся между вкладками «Жеоды» и «Слитки», чтобы видеть свои богатства Трясины.',
        position: 'bottom',
        arrowSide: 'top'
      },
      {
        ...
        text: 'Во вкладке «Слитки» ты увидишь все добытые ресурсы: от Хлама до Обычных. Хлам и Вторичку можно продать в Профиле за опыт. Обычные — береги для эволюции и крафта!',
        position: 'bottom',
        arrowSide: 'top'
      }
    ]
    ...
    subSteps: [
      {
        ...
        text: 'Прогресс-бар показывает, сколько слитков из всей энциклопедии ты уже открыл. Цель — собрать их все: от болотного хлама до космических легенд!',
        position: 'bottom',
        arrowSide: 'top'
      },
      {
        ...
        useStaticCoords: false,
        title: '🏆 Зал Славы',
        text: 'Здесь — легендарные Коллекционные Артефакты. В Трясине их три: Топяной сгусток, Сердцевина гнильца и Ржавое ядро. Они выпадают из особых жеод и дают мощные бонусы!',
        position: 'bottom',
        arrowSide: 'top'
      }
    ]
    ...
    subSteps: [
      {
        ...
        text: 'Каждые 30 минут запускается случайное событие: Великая Переплавка (крафт из метеоритных слитков) или Метеоритный Шторм (ловля метеоров). Не пропускай!',
        position: 'bottom',
        arrowSide: 'top'
      },
      {
    ...
    subSteps: [
      {
        ...
        useStaticCoords: false,
        title: '👤 Твой профиль',
        text: 'Здесь — твой уровень, статус и прогресс. От «Болотного странника» до «Легенды Трясины». Повышай Слиток — открывай новые горизонты!',
        position: 'bottom',
        arrowSide: 'top'
      },
      {
        ...
        useStaticCoords: false,
        title: '💰 Сбыт сырья',
        text: 'Продавай хлам и вторичные слитки за опыт. Но не спеши — они нужны для эволюции Слитка! Обычные слитки с Ржавого дна особенно ценны.',
        position: 'top',
        arrowSide: 'bottom'
      }
    ]
    ...
    subSteps: [
      {
        id: 'final_goodbye',
        targetSelector: null,
        title: '🎉 Ты готов к приключениям в Трясине!',
        text: 'Тапай Слиток, отправляй экспедиции в Болото, Гнилой лес и Ржавое дно, собирай коллекцию и участвуй в ивентах. Кнопка <b>?</b> всегда рядом, если что-то забудешь. Удачи, Болотный странник!',
        position: 'center',
        arrowSide: null
      }
    ]
