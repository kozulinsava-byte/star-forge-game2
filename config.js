...
export const CONFIG_ITEMS = {
    ...
    copper: { 
        ...
        description: 'Фундаментальный металл цивилизации. Медь используется в электропроводке всех космических кораблей. Её теплый блеск символизирует начало великого пути коллекционера.', 
    ...
    iron: { 
        ...
        sourceType: 'expedition', location: 'mine',
        glowClass: 'glow-iron', 
        description: 'Основа промышленности. Железо — это скелет космических станций и каркас межзвёздных крейсеров.', 
    ...
    coal: { 
        ...
        sourceType: 'expedition', location: 'mine',
        glowClass: 'glow-copper', 
        description: 'Спрессованная энергия древних лесов. Уголь — это не просто топливо, это память планеты.', 
    ...
    biocopper: { 
        ...
        glowClass: 'glow-gold', 
        description: 'Удивительный сплав, созданный симбиозом меди и микроорганизмов джунглей. Био-медь обладает способностью к самовосстановлению.', 
    ...
    oxidizedsilver: { 
        ...
        description: 'Серебро, веками лежавшее во влажных недрах джунглей. Оксидная плёнка придаёт ему радужные переливы.', 
    ...
    woodalloy: { 
        ...
        sourceType: 'expedition', location: 'jungle',
        glowClass: 'glow-gold', 
        description: 'Уникальный композит, сочетающий прочность металла и лёгкость дерева.', 
    ...
    titanium: { 
        ...
        glowClass: 'glow-platinum', 
        description: 'Бог среди металлов. Титан сочетает невероятную прочность с поразительной лёгкостью.', 
    ...
    cobalt: { 
        ...
        sourceType: 'expedition', location: 'asteroid',
        glowClass: 'glow-gold', 
        description: 'Стратегический металл для производства аккумуляторов и жаропрочных сплавов.', 
    ...
    lunarsilver: { 
        ...
        sourceType: 'expedition', location: 'asteroid',
        glowClass: 'glow-gold', 
        description: 'Серебро, миллиарды лет облучавшееся космическими лучами. Приобрело уникальный молочный оттенок.', 
    ...
    black_mirror: { 
        ...
        description: 'Загадочный артефакт, созданный в горниле Великой Переплавки. Создаётся из чистейшего угля и прочного железа.', 
    ...
    astro_bronze: { 
        ...
        sourceType: 'crafted', location: 'craft',
        glowClass: 'glow-platinum', 
        description: 'Сплав, созданный по технологиям древних космических цивилизаций.', 
    ...
    chrome_titan: { 
        ...
        sourceType: 'crafted', location: 'craft',
        glowClass: 'glow-platinum', 
        description: 'Сверхпрочная броня из титана с хромовым покрытием.', 
    ...
    platinum_alloy: { 
        ...
        description: 'Вершина кузнечного мастерства. Платина и иридий сливаются в сплав, который не подвластен времени.', 
    ...
    isotope: { 
        ...
        description: 'Древняя легенда шахтёров. Говорят, Изотоп-256 — это осколок давно погасшей звезды.', 
    ...
    osmium: { 
        ...
        description: 'Самый плотный природный элемент во вселенной. Этот осмий старше самой Солнечной системы.', 
    ...
    biosteel: { 
        ...
        description: 'Венец эволюции органических металлов. Био-Сталь растёт, дышит и способна к регенерации.', 
    ...
    relicbronze: { 
        ...
        description: 'Сплав, созданный не человеческими руками. На поверхности выгравированы символы.', 
    ...
    tungsten: { 
        ...
        description: 'Металл, прошедший горнило сверхновой. Имеет самую высокую температуру плавления.', 
    ...
    darkmatter: { 
        ...
        sourceType: 'expedition', location: 'asteroid',
        glowClass: 'glow-darkmatter', 
        description: 'Стабилизированный сгусток невидимой субстанции. Не взаимодействует со светом.', 
...
export const CRAFT_RECIPES = {
    ...
    chrome_titan: { id: 'chrome_titan', name: 'Хромированный Титан', icon: '🛡️', description: 'Броня из титана.', resultIngotId: 'chrome_titan', ingredients: { titanium: 3, cobalt: 1 }, xpReward: 55, smeltTime: 20, reqLevel: 5 },
...
export const GUILD_QUESTS = [
    ...
    { id: 'quest_7', name: 'Эпический сплав', description: 'Военные просят Изумрудную сталь.', reqLevel: 6, ingredients: { emeraldsteel: 1, titanium: 1 }, rewardXP: 150, rewardGeode: 'meteor_rare' },
